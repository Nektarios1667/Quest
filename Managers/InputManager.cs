...
public static class InputManager
{
    ...
    private static readonly Dictionary<InputAction, InputBinding> binds = new()
    {
        ...
        { InputAction.ToggleWorldInfo,              new(Keys.I) },
        ...
        { InputAction.ToggleTileConnectionsDebug,   new(Keys.F9, [Keys.LeftControl]) },
        { InputAction.OpenDebugWindow,              new(Keys.F10, [Keys.LeftControl]) },
        ...
        { InputAction.NewWaypoint,                  new(Keys.W, [Keys.LeftControl]) },
        { InputAction.DeleteWaypoint,               new(Keys.W, [Keys.LeftControl, Keys.LeftShift]) },
        { InputAction.NewTransition,                new(Keys.T, [Keys.LeftControl]) },
        { InputAction.DeleteTransition,             new(Keys.T, [Keys.LeftControl, Keys.LeftShift]) },
