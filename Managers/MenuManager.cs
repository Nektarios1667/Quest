...
public class MenuManager
{
    ...
    public MenuManager(Game window, SpriteBatch batch, ContentManager content, GameManager gameManager, PlayerManager playerManager)
    {
        ...
        Label licenseLabel = new(CreditsMenu, new(75, Constants.Window.Y - 80), Color.White, "Code and assets licensed under Creative Commons Attribution-NonCommercial-ShareAlike (CC BY-NC-SA)\nhttps://creativecommons.org/licenses/by-nc-sa/4.0/", PixelOperator);
