...
public static class TextureManager
{
    ...
    public static void LoadTextures(ContentManager content)
    {
        ...
        Metadata[TextureID.Map] = new(Textures[TextureID.Map].Bounds.Size, new(1, 1), "item");
        ...
        Metadata[TextureID.Inscriber] = new(Textures[TextureID.Inscriber].Bounds.Size, new(4, 4), "tile");
        Metadata[TextureID.Stove] = new(Textures[TextureID.Stove].Bounds.Size, new(4, 4), "tile");
        Metadata[TextureID.Furnace] = new(Textures[TextureID.Furnace].Bounds.Size, new(4, 4), "tile");
        Metadata[TextureID.DisplayCase] = new(Textures[TextureID.DisplayCase].Bounds.Size, new(4, 4), "tile");
        Metadata[TextureID.Crate] = new(Textures[TextureID.Crate].Bounds.Size, new(4, 4), "tile");
        Metadata[TextureID.Crafter] = new(Textures[TextureID.Crafter].Bounds.Size, new(4, 4), "tile");
        Metadata[TextureID.ConcreteFlooring] = new(Textures[TextureID.ConcreteFlooring].Bounds.Size, new(4, 4), "tile");
        Metadata[TextureID.StoneWindow] = new(Textures[TextureID.StoneWindow].Bounds.Size, new(4, 4), "tile");
        Metadata[TextureID.ConcreteWindow] = new(Textures[TextureID.ConcreteWindow].Bounds.Size, new(4, 4), "tile");
        ...
        Metadata[TextureID.DryWall] = new(Textures[TextureID.DryWall].Bounds.Size, new(4, 4), "tile");
        Metadata[TextureID.DryWallWindow] = new(Textures[TextureID.DryWallWindow].Bounds.Size, new(4, 4), "tile");
        Metadata[TextureID.Gravel] = new(Textures[TextureID.Gravel].Bounds.Size, new(4, 4), "tile");
        Metadata[TextureID.WetSand] = new(Textures[TextureID.WetSand].Bounds.Size, new(4, 4), "tile");
        Metadata[TextureID.RedSand] = new(Textures[TextureID.RedSand].Bounds.Size, new(4, 4), "tile");
        Metadata[TextureID.WetRedSand] = new(Textures[TextureID.WetRedSand].Bounds.Size, new(4, 4), "tile");
        ...
        Metadata[TextureID.PressurePlate] = new(Textures[TextureID.PressurePlate].Bounds.Size, new(1, 2), "tile");
        ...
        Metadata[TextureID.Sign] = new(Textures[TextureID.Sign].Bounds.Size, new(4, 4), "tile");
