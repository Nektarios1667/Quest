...
public class ItemTypes
{
    ...
    public static readonly ItemType Compass = new(ItemTypeID.Compass, "Tool used to locate your position.", 1);
    public static readonly ItemType Map = new(ItemTypeID.Map, "Allows the player to see explored areas of the world.", 1);
    // ITEMS REGISTER
...
public class Item
{
    ...
    public static Item Create(ItemTypeID itemType, byte amount, string? customName = null)
    {
        ...
        return itemType switch
        {
            ...
            ItemTypeID.Apple => new Apple(amount, customName),
            ItemTypeID.BottledWater => new BottledWater(amount, customName),
            ItemTypeID.Bread => new Bread(amount, customName),
            ItemTypeID.Carrot => new Carrot(amount, customName),
            ItemTypeID.Cheese => new Cheese(amount, customName),
            ItemTypeID.Cherries => new Cherries(amount, customName),
            ItemTypeID.Chicken => new Chicken(amount, customName),
            ItemTypeID.CookedBeef => new CookedBeef(amount, customName),
            ItemTypeID.CookedFish => new CookedFish(amount, customName),
            ItemTypeID.Orange => new Orange(amount, customName),
            ...
            ItemTypeID.Compass => new Compass(amount, customName),
            ItemTypeID.Map => new Map(amount, customName),
            // ITEMFROMID
