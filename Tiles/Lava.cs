...
public class Lava : Tile
{
    ...
    public override void Draw(GameManager gameManager)
    {
        ...
        LightingManager.SetLight($"Lava_{Location.X}_{Location.Y}", (Location.ToVector2() + Constants.HalfVec).ToPoint() * Constants.TileSize - CameraManager.Camera.ToPoint() + Constants.Middle, 4, Color.OrangeRed * 0.5f, singleFrame:true);
