...
public class Lava : Tile
{
    ...
    public override void Draw(GameManager gameManager)
    {
        ...
        LightingManager.SetLight($"Lava_{X}_{Y}", (Location.ToVector2() + Constants.HalfVec).ToPoint() * Constants.TileSize - CameraManager.Camera.ToPoint() + Constants.Middle, 4, singleFrame: true);
    }
}
